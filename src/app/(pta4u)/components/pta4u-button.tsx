...
const typesMap = {
  ...
  'outline': 'border border-[#D0D0D0] bg-white hover:!text-white hover:border-transparent hover:bg-gradient-to-r from-[#F55751] to-[#D83CA3]'
}
...
export default function Pta4uButton({ className, children, size, type }: IProps ) {
  ...
  return <button className={buttonClasses.join(' ')}>
    { children }
  </button>
}
