...
export default function Pta4uReviews() {
  return <div className={'container h-full mx-auto px-5 flex flex-col items-center'}>
    ...
    <h1 className={'text-[18px] leading-[22px] lg:text-[30px] lg:leading-[36px] font-semibold'}>Отзывы Яндекс и 2ГИС</h1>
    <p className={'mt-[20px] text-[14px] leading-[16px] lg:text-[24px] lg:leading-[36px] max-w-[760px] text-center'}>
    ...
    <p className={'mt-[4px] text-[13px] lg:text-[16px] italic font-serif text-[#747373]'}>Знаток города 5 уровня</p>
